...
import { TeamDetails } from "@/components/subject/TeamDetails";
import { AddSkillsModal } from "@/components/subject/AddSkillsModal";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <div className="bg-card rounded-lg border p-6 shadow-card">
            <div className="flex justify-between items-start">
              ...
              <AddSkillsModal 
                userId={user?.id} 
                onSkillsUpdated={() => setTeamRefresh(prev => prev + 1)}
              />
            </div>
          </div>
        </div>
        ...
        <Tabs defaultValue="partners" className="w-full">
          ...
          <TabsContent value="team">
            <TeamDetails subjectCode={subjectCode!} userId={user?.id} key={teamRefresh} />
          </TabsContent>
